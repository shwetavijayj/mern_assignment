...
import {
    ...
    CardTitle, CardSubtitle, Collapse, Input, Button
} from 'reactstrap';
...
class PersonalInfoAdminComponent extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        console.log("Hello");
        this.serve.getIncompleteUsers((err, res) => {
            if (err) {
                history.push('/error');
            }
            else {
                        ...
                        this.state.Users.map((usr, idx) => (
                            <Card>
                                <CardBody>
                                    ...
                                    <Button onClick={this.toggle.bind(this)}>Add Information</Button>
